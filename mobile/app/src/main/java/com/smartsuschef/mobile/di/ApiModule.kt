...
object ApiModule {
    ...
    @Provides
    @Singleton
    fun provideSalesApiService(retrofit: Retrofit): SalesApiService = retrofit.create(SalesApiService::class.java)

    @Provides
    @Singleton
    fun provideWastageApiService(retrofit: Retrofit): WastageApiService = retrofit.create(WastageApiService::class.java)

    @Provides
    @Singleton
    fun provideForecastApiService(retrofit: Retrofit): ForecastApiService = retrofit.create(ForecastApiService::class.java)
    ...
    @Provides
    @Singleton
    fun provideIngredientApiService(retrofit: Retrofit): IngredientApiService = retrofit.create(IngredientApiService::class.java)

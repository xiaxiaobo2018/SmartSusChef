...
class DashboardViewModelTest {
    ...
    @Test
    fun `init when all calls succeed should update all LiveData correctly`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `logout should call authRepository logout`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `init when getUser fails should set default username and stop loading`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `init when getStore fails should set default store info and stop loading`() =
        runTest {
            // ARRANGE

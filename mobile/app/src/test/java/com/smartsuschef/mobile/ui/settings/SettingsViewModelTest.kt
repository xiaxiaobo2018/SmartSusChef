...
class SettingsViewModelTest {
    ...
    // --- Initial Load Tests ---
    @Test
    fun `loadCurrentUser when succeeds should update currentUser and stop loading`() =
        runTest {
    ...
    @Test
    fun `loadCurrentUser when fails should update profileResultWithError and stop loading`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `updateProfile when succeeds should update currentUser and profileResult`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `updateProfile when fails should update profileResultWithError`() =
        runTest {
            // ARRANGE
            val newName = "Updated Name"
            val newEmail = "updated@example.com"
    ...
    @Test
    fun `updateProfile when name is blank should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `updateProfile when invalid email should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `updateProfile when email is blank should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when succeeds should update passwordResult`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `changePassword when fails should update passwordResultWithError`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("oldPass", "newValidPassword123!")
    ...
    @Test
    fun `changePassword when new password is blank should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when current password is blank should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when passwords do not match should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when new password is same as current should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when new password is too short should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when new password has no uppercase should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when new password has no lowercase should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when new password has no number should show validation error`() =
        runTest {
            // ACT
    ...
    @Test
    fun `changePassword when new password has no special char should show validation error`() =
        runTest {
            // ACT
            ...
            assertEquals(
                ...
                viewModel.passwordUpdateResult.value,
            )
            verify(mockAuthRepository, never()).changePassword(any())
        }
}

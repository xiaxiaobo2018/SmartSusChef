...
class RecipesRepositoryTest {
    ...
    @Test
    fun `getAll success should return success resource with list of RecipeDto`() =
    ...
    @Test
    fun `create success should return success resource with RecipeDto`() =
        runTest(testDispatcher) {
            // Arrange
            val createRequest =
                CreateRecipeRequest(

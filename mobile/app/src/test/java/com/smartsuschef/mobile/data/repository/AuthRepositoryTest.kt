...
class AuthRepositoryTest {
    ...
    @Test
    fun `login success should return success resource and save token`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `login api error should return error resource and not save token`() =
        runTest {
            // ARRANGE
            val loginRequest = LoginRequest("user", "pass")
    ...
    @Test
    fun `login network exception should return error resource`() =
        runTest {
            // ARRANGE
            val loginRequest = LoginRequest("user", "pass")
    ...
    @Test
    fun `changePassword success should return success resource`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `changePassword api error with incorrect password message should return specific error`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("currentPass", "newPass")
    ...
    @Test
    fun `changePassword api error with invalid format message should return specific error`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("currentPass", "newPass")
    ...
    @Test
    fun `changePassword api error with 400 code should return specific error`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("currentPass", "newPass")
    ...
    @Test
    fun `changePassword api error generic should return generic error message`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("currentPass", "newPass")
    ...
    @Test
    fun `changePassword http exception should return unexpected error`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("currentPass", "newPass")
    ...
    @Test
    fun `changePassword io exception should return network error`() =
        runTest {
            // ARRANGE
            val request = ChangePasswordRequest("currentPass", "newPass")
            whenever(mockAuthApi.changePassword(request)).thenAnswer {

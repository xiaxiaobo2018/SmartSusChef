...
class SalesRepositoryTest {
    ...
    private val sampleSalesDataDto =
        SalesDataDto(
            id = "sale1",
            date = "2023-01-01",
            recipeId = "recipe1",
    ...
    private val sampleSalesTrendDto =
        SalesTrendDto(
            date = "2023-01-01",
            totalQuantity = 100,
    ...
    private val sampleIngredientUsageDto =
        IngredientUsageDto(
            ingredientId = "ing1",
    ...
    private val sampleRecipeSalesDto =
        RecipeSalesDto(
            recipeId = "recipe1",
            recipeName = "Dish 1",
            quantity = 50,
    ...
    @Test
    fun `getAll success should return success resource with list of SalesDataDto`() =
    ...
    @Test
    fun `getAll API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getTrend success should return success resource with list of SalesTrendDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getTrend API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getIngredientUsageByDate success should return success resource with list of IngredientUsageDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getRecipeSalesByDate success should return success resource with list of RecipeSalesDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `create success should return success resource with SalesDataDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `create API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
            val createRequest = CreateSalesDataRequest("2023-01-01", "recipe1", 10)
    ...
    @Test
    fun `update success should return success resource with SalesDataDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `delete success should return success resource`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `delete API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange

...
class DataInputViewModelTest {
    ...
    @Test
    fun `submitData in sales mode with new entry should call salesRepository create and return success`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `submitData in wastage mode with new entry should call wastageRepository create and return success`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `submitData in sales mode with existing entry should call salesRepository update and return success`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `deleteEntry for wastage should call wastageRepository delete and update status`() =
        runTest {
            // ARRANGE
    ...
    @Test
    fun `submitData when repository returns error should update status to error`() =
        runTest {
            // ARRANGE
            // 1. Set the ViewModel to sales mode and select an item
            viewModel.setMode(isSales = true)
    ...
    @Test
    fun `deleteEntry when repository returns error should update status to error`() =
        runTest {
            // ARRANGE

...
class StoreRepositoryTest {
    ...
    @Test
    fun `getStore success should return success resource with StoreDto`() =
    ...
    @Test
    fun `getStore API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getStore network error should return error resource with network message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getStore HttpException should return error resource with unexpected message`() =
        runTest(testDispatcher) {
            // Arrange

...
class UsersRepositoryTest {
    ...
    @Test
    fun `getCurrentUser API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getCurrentUser network error should return error resource with network message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getCurrentUser HttpException should return error resource with unexpected message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `updateUser success should return success resource with UserDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `updateUser API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
            val request = UpdateProfileRequest("New Name", "new@example.com")
    ...
    @Test
    fun `updateUser network error should return error resource with network message`() =
        runTest(testDispatcher) {
            // Arrange
            val request = UpdateProfileRequest("New Name", "new@example.com")
    ...
    @Test
    fun `updateUser HttpException should return error resource with unexpected message`() =
        runTest(testDispatcher) {
            // Arrange
            val request = UpdateProfileRequest("New Name", "new@example.com")
            val httpException = HttpException(Response.error<UserDto>(500, "{}".toResponseBody(null)))

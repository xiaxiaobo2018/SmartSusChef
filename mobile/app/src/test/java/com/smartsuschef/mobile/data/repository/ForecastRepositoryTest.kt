...
class ForecastRepositoryTest {
    ...
    @Test
    fun `getForecast success should return success resource with list of ForecastDto`() =
    ...
    @Test
    fun `getForecast API error should return error resource with message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `getForecast HttpException should return error resource with unexpected message`() =
        runTest(testDispatcher) {
            // Arrange

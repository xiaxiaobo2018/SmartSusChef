...
class WastageRepositoryTest {
    ...
    private val sampleWastageDataDto =
        WastageDataDto(
            id = "wastage1",
            date = "2023-01-01",
            ingredientId = "ing1",
    ...
    private val sampleWastageTrendDto =
        WastageTrendDto(
            date = "2023-01-01",
            totalQuantity = 10.0,
            totalCarbonFootprint = 1.0,
            itemBreakdown = emptyList(),
        )
    ...
    @Test
    fun `getTrend success should return success resource with list of WastageTrendDto`() =
    ...
    @Test
    fun `getTrend network error should return error resource with network message`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `create success should return success resource with WastageDataDto`() =
        runTest(testDispatcher) {
            // Arrange
    ...
    @Test
    fun `update success should return success resource with WastageDataDto`() =
        runTest(testDispatcher) {
            // Arrange

...
class IngredientsRepositoryTest {
    ...
    private val sampleIngredientDto =
        IngredientDto(
            id = "ing1",
            name = "Flour",
            unit = "kg",
    ...
    @Test
    fun `getAll success should return success resource with list of IngredientDto`() =
    ...
    @Test
    fun `create success should return success resource with IngredientDto`() =
        runTest(testDispatcher) {
            // Arrange
